...
/**
 * With this option each E stepper can have its own factors for themicrostepping
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 20.3718327152 , 80, 161.3 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 150, 300, 40 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 500, 3000, 10000 }
...
// Disable homing per axis    (Toegevoegd)
#define X_HOME_DISABLE false
#define Y_HOME_DISABLE true
#define Z_HOME_DISABLE false
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 20), (Y_MIN_POS + 20), 5}
